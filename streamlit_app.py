...
def main():
    ...
    if mode == "integrations":
        st.info(
            "Prepared911 integration demo is no longer supported here.\n\n"
            "The new simulator is now in Skydio customer portal.\n\n"
            "See the new flow: https://www.loom.com/share/40dfdde81ba14823a7d7b176355ec2fe"
        )
